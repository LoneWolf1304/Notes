...
\section*{Lecture 02: Dimensional Deep Dive}\label{sec:two}
...
We identity $\frac{\rho d v}{\eta}$ to be the \textit{Reynold's number} $\SR$. Then we can say, for some $\phi$, $$\frac{F}{\rho d^2v^2} = \phi(\SR)$$ 
...
\begin{itemize}
    \item \textbf{Planck mass}: $E_p = \sqrt{\frac{\hbar c}{G}}$
     ...
     \item \textbf{Planck time}: $t_p = \sqrt{\frac{\hbar c}{G^5}}$
\end{itemize}
