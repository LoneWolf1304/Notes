...
Using the above, we get the following,
 ...
 \begin{itemize}
    ...
    \item For the process $\psi\psi^\dagger\longrightarrow\psi\psi^\dagger$ we have $i\SM = (-ig)^2\qty[\frac{i}{t-m^2+i\epsilon}+\frac{i}{\mathcolor{red}{s-m^2+i\epsilon}}]$
 \end{itemize}
 Note that the denominator of the red term can be 