...
The integral seems to be complicated. I don't know how to do this. Even Tong has left the integral like this, so it's a good time for me to stop too!\\[0.2cm]
There are two other diagrams contributing to the above process which we will see later. Another thing to say is that, these amplitudes can also be \textit{painstakingly} found out using Dyson formula and Wick's theorem, however, Feynman rules makes it really easy and elegant. And that is why we all love him!\footnote{The other set of more exciting Feynman rules about life can be found in his book \textit{Surely You're Joking, Mr. Feynman!}}