...
where $\Omega_{\rho\sigma}\in \re$ (since $\SJ^{\mu\nu}$ are purely imaginary, $ i\SJ^{\mu\nu}$ becomes real and hence $\Lambda$ becomes real as it should be) since Lorentz group is a real Lie group. 
We can write the infinitesimal transformation in the following way:
