        ...
        \begin{center}
            {\rmfamily
                \Huge{\textcolor{blue!30!black}{%
                    \textmd{{\HUGE{{G}}}}lassy {\HUGE S}ystems and \\
                     {\HUGE S}uper-cooled {\HUGE L}iquids%
                }}\\[0.7cm]
               ...
               \Large \textit{Instructor: Prof. Chandan Dasgupta }\\[0.7cm]
...
\tableofcontents
\newpage
\input{lecs/lec01.tex}
% \input{lecs/lec02.tex}
% \input{lecs/lec03.tex}
% \input{lecs/lec04.tex}
% \input{lecs/lec05.tex}
% \input{lecs/lec07.tex}
% \input{lecs/lec09.tex}

% \input{lecs/lec10.tex}

% \input{lecs/lec12.tex}
% \input{lecs/lec13.tex}
% \input{lecs/lec14.tex}
% \input{lecs/lec16.tex}
% \input{lecs/lec17.tex}
% \input{lecs/lec18.tex}
% \input{lecs/lec19.tex}
% \input{lecs/lec20.tex}
% \input{lecs/lec21.tex}
% \newpage
% \begin{appendices}
