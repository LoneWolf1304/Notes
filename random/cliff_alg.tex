        ...
        \begin{center}
            {\rmfamily
                \Huge{\textcolor{blue!30!black}{%
                    \textmd{\HUGE{C}lifford \HUGE{A}lgebra  }%
                }}\\[0.7cm]
            ...
            %     \Large \textsc{subtitle} \\[0.3cm]
            %    \Large \textit{subtitle}\\[0.7cm]
...
\tableofcontents
\newpage
\input{chaps/algebra.tex}
\input{chaps/cliff.tex}
\end{document}