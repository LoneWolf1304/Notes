...
On this note, David Deutsch tried to use physical laws to develop a computational model. He attempted to formalise a model which will simulate any arbitrary physical system. Since quantum mechanics makes the foundation of natural laws, the idea of a \textit{universal quantum computer} was established!