...
\newcommand{\rn}[2]{\mathrm{R}_{#1}\qty(#2)}
\newcommand{\rni}[2]{\mathrm{R}_{#1}^{-1}\qty(#2)}
        ...
        \begin{center}
            {\rmfamily
                \Huge{\textcolor{blue!30!black}{%
                    \textmd{{\HUGE{{Q}}}}uantum {\HUGE I}nformation \\
                     {\HUGE P}rocessing
                }}\\[0.7cm]
               ...
               \Large \textit{Instructor: Prof. Chiranjib Mitra}\\[1cm]
...
\node[scale=2]{
            \begin{quantikz}
     & \gate[style={fill=cyan!20,rounded
corners}, label style= black]{H} & \ctrl{1}&\\  && \targ[style={fill=cyan!20}, label style= black]{}
    &
