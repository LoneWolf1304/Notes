...
$$F(\lambda^{a\tund{t}}t, \lambda^{a\tund{h}}h) = \lambda F(t,h)\quad \longrightarrow \quad -\pdv{h}\qty[F(\lambda^{a\tund{t}}t, \lambda^{a\tund{h}}h)] = -\pdv{h}\qty[F(t,h)] \implies \lambda^{a\tund{h}-1} m(\lambda^{a\tund{t}}t, \lambda^{a\tund{h}}h) =m(t,h)$$
