...
What it physically means is that, there are infinite directions in which, if we start, then we will not converge to the fixed point. Only starting on the particular \textit{critical} surface will lead us to the fixed point.\\[0.2cm]
