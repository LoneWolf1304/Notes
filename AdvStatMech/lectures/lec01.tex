...
\section*{Lecture 01: Introduction and Van der Waal's Equation of State}
\addcontentsline{toc}{section}{Lecture 01: Intro and Van der Waal's Equation of State}
...
\begin{equation}\label{eqn:density1}
...
\begin{align*}
   ...
   &=\sum\limits_i\sum\limits_{j\neq i} \int\dd^3 q_1\ \delta^{(3)}(\vb{q}_1-\vb{q}_i)\cdot u(\abs{\vb{q}_1-\vb{q}_j})\\
   &=\sum\limits_i\sum\limits_{j\neq i} \int\dd^3 q_1\ \delta^{(3)}(\vb{q}_1-\vb{q}_i)\cdot \int\dd q_2 \ \delta^{(3)}(\vb{q}_2-\vb{q}_j)\cdot u(\abs{\vb{q}_1-\vb{q}_2})\\
   &=\int\dd^3 q_1\dd q_2\ \sum\limits_i\sum\limits_{j\neq i} \delta^{(3)}(\vb{q}_1-\vb{q}_i)\cdot  \ \delta^{(3)}(\vb{q}_2-\vb{q}_j)\cdot u(\abs{\vb{q}_1-\vb{q}_2})\\
   &=\int\dd^3 q_1\dd q_2\ n(\vb{q}_1)n(\vb{q}_2)u(\abs{\vb{q}_1-\vb{q}_2})
\end{align*}
...
Then, 
$$U = \frac{n^2}{2}\int\dd^3 q_1 \dd^3 q_2\ u(\abs{\vb{q}_1-\vb{q}_2})$$
