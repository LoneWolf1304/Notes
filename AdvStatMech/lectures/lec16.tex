...
\begin{align*}
    \sqrt{\frac{2\gamma}{a_4}} \frac{1}{m_\infty}\tanh^{-1}\qty(\frac{m}{m_\infty})= (x-x\tund{0})\implies m(x) &= m_\infty \tanh\qty[\frac{m_\infty(x-x\tund{0})}{\sqrt{2}\qty(\gamma/a_4)^{1/2}}]\\&= m_\infty \tanh\qty[\frac{(x-x\tund{0})}{\mathcolor{red}{\sqrt{2}\qty(\gamma/a_4)^{1/2}\qty(a_2(T_c-T)/a_4)^{-1/2}}}]
\end{align*}
