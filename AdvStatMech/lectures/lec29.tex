...
\begin{align}\label{RGlinear}
    \delta K_m' = \sum\limits_{n} M_{mn} K_n \qquad \qquad \text{where } M_{mn} \equiv \pdv{K'_m}{K_n}\Bigg|_{\vb{K}^*} 
\end{align}
