...
% Text Node
\draw (123,161.4) node [anchor=north west][inner sep=0.75pt]    {$S( U+\triangle U,V,N)$};
% Text Node
\draw (319,162.4) node [anchor=north west][inner sep=0.75pt]    {$S( U-\triangle U,V,N)$};
% Text Node
\draw (289,108.4) node [anchor=north west][inner sep=0.75pt]    {$\triangle U$};
