        ...
        \begin{center}
            {\rmfamily
                \Huge{\textcolor{blue!30!black}{%
                    \textmd{{\HUGE{{A}}}}dvanced {\HUGE S}tatistical \\
                     {\HUGE P}hysics%
                }}\\[0.7cm]
               ...
               \Large \textit{Instructor: Prof. Bhavtosh Bansal }\\[1cm]
...
% \end{pmatrix}$
        ...
        \begin{figure}[H]
            \centering
           \includegraphics[scale=0.5]{pics/ising.pdf}
        \end{figure}
        \vspace{1cm}
        \begin{center}
