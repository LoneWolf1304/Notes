        ...
        \begin{center}
            {\rmfamily
                \Large{\textcolor{blue!30!black}{%
                    \textmd{{\Large{{A}}}}dvanced {\Large S}tatistical {\Large M}echanics \\
                     {\Large Assignment} 01%
                }}\\[0.4cm]
            }
            \end{center}
        \begin{center}
           \large \texttt{{{\LARGE  S}agnik {\LARGE S}eth\hspace{0.3cm} 22MS026 }}
        \end{center}
\hrule
\vspace{0.08cm}
\hrule
