...
\fancyhead[L]{ \textit{Summer Course}}
\fancyhead[C]{ Lie Groups}
\fancyfoot[C]{\thepage}
\fancyfoot[R,L]{}
\usetikzlibrary{calc}
\pagestyle{fancy}
...
\newcommand{\lGL}{\mathrm{\mathfrak{gl}}}
\newcommand{\lSL}{\mathrm{\mathfrak{sl}}}
\newcommand{\lSO}{\mathrm{\mathfrak{so}}}
\newcommand{\lSU}{\mathrm{\mathfrak{su}}}
\begin{document}
\makeatletter
\begin{titlepage}
        ...
        \begin{center}
            {\rmfamily
                \Huge{\textcolor{blue!30!black}{%
                    \textmd{{\HUGE{{P}}}}hysics {\HUGE I}nspired {\HUGE I}ntroduction {\HUGE T}o  \\
...
% \end{pmatrix}$
        ...
        \begin{figure}[H]
            \centering
          \includesvg[scale=0.6]{plot&diagrams/lie.svg}
        \end{figure}
        \vspace{1cm}
        \begin{center}
...
\tableofcontents
\newpage
\input{lectures/group.tex}
\input{lectures/rep.tex}
\input{lectures/lie.tex}
\input{lectures/lorentz.tex}
\end{document}