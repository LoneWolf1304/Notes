...
\end{align*}
By choosing an appropriate coordinate system, we can always set the first derivative to zero \footnote{Note that since first derivative roughly gives us the slope of the tangent, with proper rotation and shifting of the coordinates, we can indeed align our coordinate system along the tangent so that it's slope is zero} and we have a result that,
...
Now, for the sake of getting our hands dirty, let us calculate the Ricci scalar of $\mathbb{S}^2$ (sphere), of radius $r\tund{0}$. 
\begin{figure}[H]
    \centering 
    \input{pics/2sphere.tex}
\end{figure}
\noindent
...
$$ds^2 = r\tund{0}^2\dd\theta^2 + r\tund{0}^2\sin^2\theta\dd\phi^2 $$
From there we get the metric tensor and inverse metric tensor as:
$$g_{\mu\nu} = \mathrm{diag}(r\tund{0}^2, r\tund{0}^2\sin^2\theta)\qquad g^{\mu\nu} = \mathrm{diag}(\sfrac{1}{r\tund{0}^2}, \sfrac{1}{r\tund{0}^2\sin^2\theta})$$
...
\begin{align*}
    ...
    &=\frac{1}{r\tund{0}^2\sin^2\theta} g_{\theta\sigma}\rie{\sigma}{\phi}{\theta}{\phi }\\
    &=\frac{1}{r\tund{0}^2\sin^2\theta} r\tund{0}^2\rie{\theta}{\phi}{\theta}{\phi }\qquad \text{($\because g$ diagonal, so $\sigma = \theta$)}\\
    &=1
\end{align*}
...
\begin{align*}
    R = \tensor{R}{^\mu _\mu} = g^{\mu\nu}R_{\mu\nu} = \frac{1}{r\tund{0}^2}\times 1 + \frac{1}{r\tund{0}^2\sin^2\theta}\times \sin^2\theta = \frac{2}{r\tund{0}^2}
\end{align*}
Thus we obtain that the Ricci scalar for the sphere is $\frac{2}{r\tund{0}^2}$. Thus, the Ricci scalar indeed refers to the usual curvature and its inverse represents the radius of curvature!
$$R^{-1}\sim r\tund{0}^2$$