...
We define $d\tau$ to be the \textit{proper time} which is a scalar, since it is constructed out of two scalars. The minus sign in the definition results from the convention of the $(-,+,+,+)$ metric that we had chosen. \\[0.2cm]
...
\subsubsection{Metric in STR}\label{sec:aa}
