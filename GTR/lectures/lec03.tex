...
\end{minipage}
   ...
   \end{itemize}
   Hence, all the established laws were destroyed by the mere change of a transformation. We desperately needed another theory to reconcile with the physical laws. This lead to the formulation of special and general relativity. \\[0.2cm]
   ...
   \end{itemize}
   Note that for light, $\dv{r}{t} = \pm c\implies dr^2 = c^2dt^2 \implies ds^2 =0$. Hence, we call the interval light-like. Trajector of light is a null trajectory. However, all massive objects move along a time-like trajectory.