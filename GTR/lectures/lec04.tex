...
Here $x^0 = ct$ and $x^1=x, x^2=y, x^3=z$. Note that since $t$ and $x$ are not dimensionally same, we took $x^0=ct$ to make it in terms of ditance. We multiplied by $c$ (and not any other velocity) because $c$ is a universal constant. \\[0.2cm]
