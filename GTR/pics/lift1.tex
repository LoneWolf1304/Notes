...
\tikzset {_vyg9e8l27/.code = {\pgfsetadditionalshadetransform{ \pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 }  }}}
\pgfdeclareradialshading{_f9ouxafwp}{\pgfpoint{0bp}{0bp}}{rgb(0bp)=(1,1,1);
rgb(0bp)=(1,1,1);
rgb(25bp)=(0,0,0);
rgb(400bp)=(0,0,0)}
\tikzset{_fl1qnfeiv/.code = {\pgfsetadditionalshadetransform{\pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 } }}}
\pgfdeclareradialshading{_9i5ok6d0n} { \pgfpoint{0bp} {0bp}} {color(0bp)=(transparent!0);
color(0bp)=(transparent!0);
color(25bp)=(transparent!10);
color(400bp)=(transparent!10)} 
\pgfdeclarefading{_80wt3hz1j}{\tikz \fill[shading=_9i5ok6d0n,_fl1qnfeiv] (0,0) rectangle (50bp,50bp); } 

% Gradient Info
  
\tikzset {_53ufc3vk7/.code = {\pgfsetadditionalshadetransform{ \pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 }  }}}
\pgfdeclareradialshading{_yhstk5aj6}{\pgfpoint{0bp}{0bp}}{rgb(0bp)=(1,1,1);
rgb(0bp)=(1,1,1);
rgb(25bp)=(0,0,0);
rgb(400bp)=(0,0,0)}
\tikzset{_fvra7frx2/.code = {\pgfsetadditionalshadetransform{\pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 } }}}
\pgfdeclareradialshading{_swq3qla33} { \pgfpoint{0bp} {0bp}} {color(0bp)=(transparent!0);
color(0bp)=(transparent!0);
color(25bp)=(transparent!10);
color(400bp)=(transparent!10)} 
\pgfdeclarefading{_sa5n3jfxz}{\tikz \fill[shading=_swq3qla33,_fvra7frx2] (0,0) rectangle (50bp,50bp); } 

% Gradient Info
  
\tikzset {_szg77uz5v/.code = {\pgfsetadditionalshadetransform{ \pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 }  }}}
\pgfdeclareradialshading{_0y7l3rum2}{\pgfpoint{0bp}{0bp}}{rgb(0bp)=(1,1,1);
rgb(0bp)=(1,1,1);
rgb(25bp)=(0,0,0);
rgb(400bp)=(0,0,0)}
\tikzset{_s8c3w1hzi/.code = {\pgfsetadditionalshadetransform{\pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 } }}}
\pgfdeclareradialshading{_cvop1nebm} { \pgfpoint{0bp} {0bp}} {color(0bp)=(transparent!0);
color(0bp)=(transparent!0);
color(25bp)=(transparent!10);
color(400bp)=(transparent!10)} 
\pgfdeclarefading{_txva5r6tc}{\tikz \fill[shading=_cvop1nebm,_s8c3w1hzi] (0,0) rectangle (50bp,50bp); } 

% Gradient Info
  
\tikzset {_1janr2nkd/.code = {\pgfsetadditionalshadetransform{ \pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 }  }}}
\pgfdeclareradialshading{_ypwh5nv94}{\pgfpoint{0bp}{0bp}}{rgb(0bp)=(1,1,1);
rgb(0bp)=(1,1,1);
rgb(25bp)=(0,0,0);
rgb(400bp)=(0,0,0)}
\tikzset{_z1cbyjsw0/.code = {\pgfsetadditionalshadetransform{\pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformscale{1 } }}}
\pgfdeclareradialshading{_jkxniirnh} { \pgfpoint{0bp} {0bp}} {color(0bp)=(transparent!0);
color(0bp)=(transparent!0);
color(25bp)=(transparent!10);
color(400bp)=(transparent!10)} 
\pgfdeclarefading{_wuk45eioo}{\tikz \fill[shading=_jkxniirnh,_z1cbyjsw0] (0,0) rectangle (50bp,50bp); } 
...
\path  [shading=_f9ouxafwp,_vyg9e8l27,path fading= _80wt3hz1j ,fading transform={xshift=2}] (332,79.76) -- (360.84,47) -- (389.68,79.76) -- (375.26,79.76) -- (375.26,128.9) -- (346.42,128.9) -- (346.42,79.76) -- cycle ; % for fading 
...
\draw [shading=_yhstk5aj6,_53ufc3vk7,path fading= _sa5n3jfxz ,fading transform={xshift=2}]   (374.68,102.8) -- (415.68,102.8)(374.68,105.8) -- (415.68,105.8) ;

%Up Arrow [id:dp23881564814673806] 
\path  [shading=_0y7l3rum2,_szg77uz5v,path fading= _txva5r6tc ,fading transform={xshift=2}] (578.68,80.76) -- (549.84,48) -- (521,80.76) -- (535.42,80.76) -- (535.42,129.9) -- (564.26,129.9) -- (564.26,80.76) -- cycle ; % for fading 
...
\draw [shading=_ypwh5nv94,_1janr2nkd,path fading= _wuk45eioo ,fading transform={xshift=2}]   (536,106.8) -- (495,106.8)(536,103.8) -- (495,103.8) ;
