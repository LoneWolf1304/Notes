        ...
        \begin{center}
            {\rmfamily
                \Huge{\textcolor{blue!30!black}{%
                    \textmd{{\HUGE{{C}}}}ondensed {\HUGE M}atter\\
                     {\HUGE P}hysics %
                }}\\[0.7cm]
               ...
               \Large \textit{Instructor: Prof. Subhasis Sinha  }
...
% \end{pmatrix}$
        ...
        \begin{figure}[H]
            \centering
            \includesvg[scale=0.4]{plot&diagrams/11_nearly_free_electron_model.md_2_0.svg}
        \end{figure}
        \vspace{1cm}
        \begin{center}
