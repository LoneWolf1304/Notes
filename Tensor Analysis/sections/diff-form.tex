...
In our usual sense, we imagine vectors as straight arrows drawn from the origin but in manifolds, which is `curved', firstly, straight arrows cannot be drawn and secondly, there is no origin from which the arrow can be drawn. 
