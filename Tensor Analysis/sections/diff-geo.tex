...
\end{align*}
Now, since partial derivatives commute, we can safely say that the Lie Bracket is zero \emoji{smile}. Now, using Lemma \ref{lemma:lie}, taking $f=X^i$ and $g = Y^j$, we can write:
\begin{align*}
